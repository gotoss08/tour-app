...
!function ($) {
    ...
    Typeahead.prototype = {
        ...
        render: function (items) {
            ...
            if(that.autoSelect){
                ...
                if (this.options.onSelectionUpdate) {
                    ...
                    this.options.onSelectionUpdate({ value: value, text: text });
                }
            }
        ...
        next: function (event) {
            ...
            if (this.options.onSelectionUpOrDown) {
                var value = next.attr('data-value');
                var text = next.text();

                this.options.onSelectionUpOrDown({ value: value, text: text });
            }
        },
        prev: function (event) {
            var active = this.$menu.find('.active').removeClass('active'),
