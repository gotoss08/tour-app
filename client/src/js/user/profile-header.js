...
$(document).ready(() => {
    ...
    if (profileData.currentUser) $('#header .header-page-control-section').append('<a href="/p/new" class="header-link ml-1" title="Новая заметка"><i class="fas fa-pencil-alt"></i></a>');
